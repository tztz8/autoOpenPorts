...
class Gateway {
    ...
    public boolean openPort(int portOut, int portIn, String ip, String description, boolean udp) {
        if (portIn < 0 || portIn > 65535 || portOut < 0 || portOut > 65535) {
            throw new IllegalArgumentException("Invalid port");
        }
        Map<String, String> params = new HashMap<String, String>();
        params.put("NewRemoteHost", "");
        ...
        params.put("NewExternalPort", "" + portOut);
        params.put("NewInternalPort", "" + portIn);
        params.put("NewEnabled", "1");
    ...
    public Map<String, String> isMappedReturnOutPut(int port, boolean udp) {
        if (port < 0 || port > 65535) {
            throw new IllegalArgumentException("Invalid port");
        }
        Map<String, String> params = new HashMap<String, String>();
