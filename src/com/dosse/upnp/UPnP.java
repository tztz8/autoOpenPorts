...
public class UPnP {
     ...
     * @return true if the operation was successful, false otherwise
     */
    public static boolean openPortTCP(int portOut, int portIn, String ip, String description) {
        if(!isUPnPAvailable()) return false;
        return defaultGW.openPort(portOut, portIn, ip, description, false);
    }
     ...
     * @return true if the port is mapped, false otherwise
     */
    public static Map<String, String> isMappedTCPReturnOutPut(int port) {
        if(!isUPnPAvailable()) return null;
        return defaultGW.isMappedReturnOutPut(port, false);
    }
